...
# coding: utf8
"""
Importer data from EMISS (fedstat.ru) to open data hub
"""
import ckanclient
import csv
import os, os.path
    ...
    def collect_data(self):
        ...
        for filename in files:
            ...
            if ext == '.xml':
                ...
                xlsfilename = ''
                if os.path.exists('data/data_' + id + '.xls'):
